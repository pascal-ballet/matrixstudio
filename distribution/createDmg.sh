...
VERSION=`cat ../out/production/ui/matrixstudio/ui/version.properties | grep version | awk -F= '{ print $2 }'`
DATE=`cat ../out/production/ui/matrixstudio/ui/version.properties | grep date | awk -F= '{ print $2 }'`
