...
import matrixstudio.ui.LogHandler;
import matrixstudio.ui.MatrixStudio;
...
public class Simulator implements Runnable {
    ...
    public Simulator(MatrixStudio ui) {
    	this.ui = ui;
    	this.log = ui.getLogHandler();
    }
	...
	private final MatrixStudio ui; // Not sure this is aood place to set a ui reference... But usefull to know when save the mpeg animation
	// I'm sure it's not a good place (JcR).
    ...
    public void run() {
    	try {
    		...
    		// catch any exception.
    		ui.error(DiagnosticUtil.createMessage(e));
    	} finally {
    		// what ever happen, reset every thing
    		reset();
       		ui.log("Simulation ended.");
       		monitor.done();
    	}
    }
}
